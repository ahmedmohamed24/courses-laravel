...
<main>
    ...
    <div id="map" class="container my-3"></div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAA4iDCBP_tV53q5-1PGFzCkVqnkhHkGPA&callback=initMap&libraries=&v=weekly" defer ></script>
    <script>
        let map;
        function initMap() {
   ...
   <script>
        ...
        $('#formData').submit(function(e){
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('sendFeedback')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                cache: false,
...
<?php echo $__env->make('front.layout.frontLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/laravel-projects/courses-laravel/resources/views/front/contact.blade.php ENDPATH**/ ?>